    ...
    <nav class="mb-1 navbar navbar-expand-lg navbar-dark navbar-custom">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a  class="nav-link <?php if($page == 'appointments') {echo 'active';} ?>" href="AppointmentPage.php">Home</a>
                </li>
                <li class="nav-item">
                    <a  class="nav-link <?php if($page == 'patient') {echo 'active';} ?>" href="PatientPage.php">Patient</a>
                </li>
                <li class="nav-item">
                    <a  class="nav-link <?php if($page == 'billing') {echo 'active';} ?>" href="BillingPage.php">Biling</a>
                </li>
                <li class="nav-item">
                    <a  class="nav-link <?php if($page == 'medicalinventory') {echo 'active';} ?>" href="MedicinAndServicesPage.php">Medicine and Services</a>
                </li>
