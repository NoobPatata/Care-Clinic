    ...
    <nav class="mb-1 navbar navbar-expand-lg navbar-dark navbar-custom">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a  class="nav-link <?php if($page == 'home') {echo 'active';} ?>" href="AdminPage.php">Home</a>
                </li>
                <li class="nav-item">
                    <a  class="nav-link <?php if($page == 'adduser') {echo 'active';} ?>" href="AddUserPage.php">Add User</a>
                </li>
